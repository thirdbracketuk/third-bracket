...
//   'marketing companies manchester',
//   'social media companies in manchester',
...
export const keywords = [
  ...
  'web development manchester',
  'bespoke web design manchester',
  'seo agency manchester',
  'seo services manchester',
  'branding agency manchester',
  'web design for small business manchester',
  'web design for startups manchester',
  'affordable web design manchester',
  'wordpress web design manchester',
  'next.js web development',
  'woocommerce development',
  'ecommerce web design manchester',
  'local seo manchester',
  'google business setup manchester',
  'brand identity manchester',
  'logo design manchester',
  'elementor web design',
  'website redesign manchester',
  'website optimisation',
  'technical seo',
  'geo search optimisation',
  'bracketui tailwind component library',
