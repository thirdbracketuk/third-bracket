...
export const WorkMockup: React.FC<WorkMockupProps> = ({ work }) => {
  ...
  return (
    <>
      {/* ── Device mockup strip ── */}
      <section className="rounded-3xl overflow-hidden my-8 border-2 border-dashed bg-white/30 dark:bg-black/30 border-secondary-100  dark:border-secondary-900/70">
