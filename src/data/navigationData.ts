...
export const webDevelopmentItems: NavlinkItem[] = [
  {
    label: 'Bespoke Web Design',
    href: '/services/website-ecommerce#bespoke-web-design',
    isDropdownItem: true,
  },
  {
    label: 'Bespoke Web Development',
    href: '/services/website-ecommerce#bespoke-web-development',
    isDropdownItem: true,
  },
  {
    label: 'E-commerce Development',
    href: '/services/website-ecommerce#ecommerce-development',
    isDropdownItem: true,
  },
  {
    label: 'Website Redesign',
    href: '/services/website-ecommerce#website-redesign',
    isDropdownItem: true,
  },
  {
    label: 'Website Repair',
    href: '/services/website-ecommerce#website-repair',
    isDropdownItem: true,
  },
  {
    label: 'Website Optimisation',
    href: '/services/website-ecommerce#website-optimisation',
    isDropdownItem: true,
  },
  {
    label: 'Website Migration',
    href: '/services/website-ecommerce#website-migration',
    isDropdownItem: true,
  },
]
...
export const seoGrowthItems: NavlinkItem[] = [
  { label: 'WordPress SEO', href: '/services/seo-growth#wordpress-seo', isDropdownItem: true },
  { label: 'WooCommerce SEO', href: '/services/seo-growth#woocommerce-seo', isDropdownItem: true },
  {
    label: 'Custom Ecommerce SEO',
    href: '/services/seo-growth#custom-ecommerce-seo',
    isDropdownItem: true,
  },
  { label: 'Local SEO', href: '/services/seo-growth#local-seo', isDropdownItem: true },
  { label: 'GEO', href: '/services/seo-growth#geo', isDropdownItem: true },
  { label: 'SEO & PPC', href: '/services/seo-growth#seo-ppc', isDropdownItem: true },
  {
    label: 'Google Business Setup',
    href: '/services/seo-growth#google-business',
    isDropdownItem: true,
  },
  {
    label: 'Digital Foundation',
    href: '/services/seo-growth#digital-foundation',
    isDropdownItem: true,
  },
]
...
export const brandingCreativeItems: NavlinkItem[] = [
  {
    ...
    href: '/services/branding-creative#brand-strategy',
    isDropdownItem: true,
  },
  {
    label: 'Brand Identity',
    href: '/services/branding-creative#brand-identity',
    isDropdownItem: true,
  },
  {
    label: 'Print & Signage Design',
    href: '/services/branding-creative#print-signage',
    isDropdownItem: true,
  },
  {
    label: 'Social Media Branding',
    href: '/services/branding-creative#social-media-branding',
    isDropdownItem: true,
  },
  {
    label: 'Illustration & Graphics',
    href: '/services/branding-creative#illustration-graphics',
    isDropdownItem: true,
  },
  {
    label: 'Video Editing',
    href: '/services/branding-creative#video-editing',
    isDropdownItem: true,
  },
]
...
export const resourcesItems: NavlinkItem[] = [
  ...
  { label: 'Open Source', href: '/open-source', isDropdownItem: true },
