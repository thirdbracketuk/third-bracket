...
import { wordpressSolutionsItems } from '@/data/navigationData'
import CTASection from '@/components/CTASection'
import { Bracket } from '@thirdbracket/bracketui'

const wordpressSolutionsCategory = {
  title: 'WordPress Solutions',
  description:
    'High-performance WordPress solutions optimized for speed, security, and scalability.',
  solutions: wordpressSolutionsItems.map((item) => ({
    title: item.label,
    ...
    <section>
      <Bracket fluid centered padding="small">
        <div className="md:max-w-screen-xl mx-auto">
          <PageHeader
            title="WordPress Solutions"
            description="High-performance WordPress solutions optimized for speed, security, and scalability."
          />
