  ...
  return (
    ...
    >
      ...
      <div className="flex items-baseline">
        ...
        <span className="text-[6px]/[8px] font-normal ml-1 bg-gradient-to-r from-primary-800 via-secondary-700 to-secondary-600 dark:from-primary-200 dark:via-secondary-300 dark:to-secondary-400 bg-clip-text text-transparent uppercase inline-block">
          Ltd
        </span>
      </div>
    </div>
