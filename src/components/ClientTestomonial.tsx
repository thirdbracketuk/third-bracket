                  ...
                  {item.logo && (
                    ...
                    <div className="relative flex-shrink-0 w-24 h-10">
                      <Image
                        ...
                        fill
                        sizes="96px"
                        className="object-contain object-right transition-all duration-700 ease-out opacity-20 blur-[1px] brightness-75 dark:brightness-150 group-hover:opacity-100 group-hover:blur-0 group-hover:brightness-100 group-hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.3)] dark:invert
      "
                      />
                    </div>
                  )}
